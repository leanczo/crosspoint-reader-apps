...
enum UIIcon { Folder, Text, Image, Book, File, Recent, Settings, Transfer, Library, Wifi, Hotspot, Calculator, Weather, Sudoku, Clock, Wikipedia, Chess, Dice, DuckDuckGo, Rss, TicTacToe, FormulaOne, Snake, Football, Calendar, Map };
...
class BaseTheme {
 public:
  ...
  void drawClock(const GfxRenderer& renderer, Rect rect) const;
